...
class _WatchPartyChatOverlayState extends State<WatchPartyChatOverlay> {
  ...
  void initState() {
    ...
    _messages.addAll(_watchPartyService.sessionMessages);
    
    // Store existing callback if any
    final existingCallback = _watchPartyService.onChatMessage;
    _watchPartyService.onChatMessage = (message) {
      // Call existing callback first
      existingCallback?.call(message);
  ...
  Future<void> _sendMessage() async {
    ...
    await _watchPartyService.sendChatMessage(text);
  }
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  const Icon(Icons.chat_bubble_outline, color: Colors.amber, size: 24),
              ...
              child: _messages.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isCurrentUser = message.participantId ==
