              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      ...(_stats!['typeCounts'] as Map<String, dynamic>).entries.map((entry) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            leading: Icon(_getIconForType(typeName), color: Colors.white),
                            title: Text(
                              typeName,
                            ...
                            subtitle: LinearProgressIndicator(
                              ...
                              valueColor: AlwaysStoppedAnimation<Color>(_getColorForType(typeName)),
                            ),
                            trailing: Text(
                              '$count ($percentage%)',
                      ...
                      ...((_stats!['mostViewed'] as List).take(5).map((linkJson) {
                        final link = SavedLink.fromJson(linkJson as Map<String, dynamic>);
                        return Card(
                          color: Colors.grey[900],
                          margin: const EdgeInsets.only(bottom: 8),
                          child: ListTile(
                            leading: Icon(_getIconForType(link.type.toString().replaceAll('LinkType.', '')), color: Colors.white),
                            title: Text(
                              link.title,
                              style: const TextStyle(color: Colors.white),
                              maxLines: 1,
